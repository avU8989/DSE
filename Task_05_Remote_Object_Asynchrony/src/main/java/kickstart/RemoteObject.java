...
public class RemoteObject implements RemoteService {
	...
	public boolean hasEnoughSpace(int entriesToAdd) {
		int remainingSpace = storage.length - nextEntryPointer;
		return remainingSpace >= entriesToAdd;
	}
